...
dV0(U,p) = [p[1]*(1.0 - U^2/c^2)]

data = MechanicsDatasets.keplerproblem(dV0, true_u0, true_p, ϕ0)

angles = [50.0, 70.0, 20.0].*π/180 # vcat(S2_orbitalelements.i, S2_orbitalelements.Ω, S2_orbitalelements.ω).*π/180 # 
...
cb = function(p,l,pred)
    ...
    if epoch % 5 == 0
        ...
        dv0 = map(u -> dV0(u, true_p[2:end])[1], 1 ./ R0)
